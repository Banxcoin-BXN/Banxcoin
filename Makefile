...
pkgdatadir = $(datadir)/banxcoin
pkgincludedir = $(includedir)/banxcoin
pkglibdir = $(libdir)/banxcoin
pkglibexecdir = $(libexecdir)/banxcoin
...
ACLOCAL = ${SHELL} /tmp/Banxcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/Banxcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/Banxcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/Banxcoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = banxcoin-cli
BITCOIN_DAEMON_NAME = banxcoind
BITCOIN_GUI_NAME = banxcoin-qt
BITCOIN_TX_NAME = banxcoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The Banxcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Banxcoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/Banxcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = banxcoin
PACKAGE_BUGREPORT = https://github.com/banxcoin-project/banxcoin/issues
PACKAGE_NAME = Banxcoin Core
PACKAGE_STRING = Banxcoin Core 1.0.0
PACKAGE_TARNAME = banxcoin
PACKAGE_URL = https://banxcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/Banxcoin
abs_srcdir = /tmp/Banxcoin
abs_top_builddir = /tmp/Banxcoin
abs_top_srcdir = /tmp/Banxcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/Banxcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Banxcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Banxcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Banxcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Banxcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
