...
* banxcoin.conf: contains configuration settings for banxcoind or banxcoin-qt
* banxcoind.pid: stores the process id of banxcoind while running
...
* debug.log: contains debug information and general logging generated by banxcoind or banxcoin-qt
