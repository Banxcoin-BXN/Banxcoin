...
"""Verify that starting banxcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start banxcoin with -h for help text")
        ...
        self.log.info("Start banxcoin with -version for version information")
