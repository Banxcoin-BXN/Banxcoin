...
const char * const BITCOIN_CONF_FILENAME = "banxcoin.conf";
const char * const BITCOIN_PID_FILENAME = "banxcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Banxcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Banxcoin";
#else
    // Unix
    return pathRet / ".banxcoin";
#endif
#endif
}
