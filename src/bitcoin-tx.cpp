...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s banxcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  banxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded banxcoin transaction") + "\n" +
              "  banxcoin-tx [options] -create [commands]   " + _("Create hex-encoded banxcoin transaction") + "\n" +
              "\n";
